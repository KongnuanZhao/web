...
import com.acsm.test.utils.ExcelDataProvider;
import com.acsm.test.utils.LogConfiguration;
...
//		waitMillisecondsForAlert = Integer.valueOf(context.getCurrentXmlTest().getParameter("waitMillisecondsForAlert"));
		...
		try {
			...
			if (browserName.equalsIgnoreCase("chrome") || browserName.equalsIgnoreCase("firefox")) {
				...
				seleniumUtil.launchBrowserRemote(browserName, context,webUrl,timeOut,localhost);
